    ...
    <form class="form form-horizontal" action="{{url('admin/dologin')}}" method="post">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="" name="manager_name" value="{{old('user_name')}}" type="text" placeholder="用户名" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="manager_pwd" value="{{old('user_pass')}}" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="{{url('admin/yzm')}}" value="{{old('code')}}" onclick="this.src='{{url('/admin/yzm')}}?'+Math.random()" alt=""> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
